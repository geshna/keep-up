        ...
        if error != nil {
            ...
            Auth.auth().createUser(withEmail: email, password: password) { (result, err) in
                ...
                if err != nil {
                    ...
                    /*let docRef1 = db.collection("users").addDocument(data: ["firstname":firstName, "lastname":lastName, "email": email, "password": password, "uid":result!.user.uid, "habits":[]]) { (error) in
